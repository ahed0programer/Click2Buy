...
<body>
    ...
    <div class="page">
        <div style="margin: 20px;">
            ...
            <form class="new-row-form" action="{{ route('create_row') }}" method="post" enctype="multipart/form-data">
                @csrf
                @method('POST')
                <div class="sidebar">
                    <div class="form_form">
                        <h3 class="h3">add new row</h3>
        ...
        <ul>
            @foreach ($rows as $row)
                <li>
                    <form class="new-row-form" action="{{ route('edit_row', $row->id) }}" method="post"
                        ...
                        <div class="form">
                            ...
                            <div class="form-group">
                                ...
                                <a href="{{ route('soft_delete_row', $row->id) }}"><img src="image/delete.png"
