...
<head>
    ...
    <title>Edit Category Click 2 Buy</title>
                ...
                <div class="body-section">
                    <div class="body-content">
                        ...
                        <div class="main">
                            ...
                            <a href="{{ route('pageaddcategory') }}" style="color: #fff"><button class="button add">add
                                    new category</button></a>
                            <div class="main-content">
                                <div>
                                    <div class="new-post-form product">
                                        <form class="new-product-form"
                                            action="{{ route('edit_category', $category->id) }}" method="post"
                                            enctype="multipart/form-data">
                                            @csrf
                                            @method('POST')
                                            <div class="container">
                                                <div class="title">
                                                    <h2 style="color: white"><i>Edit category</i> </h2>
                                                </div>
                                            ...
                                            <div class="form-field field-1 medium"
                                                ...
                                                <input id="category" type="text" name="category"
                                                    ...
                                                    style="max-width: 100%;border-radius: 8px;"value="{{ $category->name }}">
                                                    ...
                                                    <select id="parent_id" name="parent_id" style="border-radius: 8px;">
                                                        ...
                                                        @foreach ($categories as $cat)
                                                            <option value="{{ $cat->id }}" class="option"
                                                                @if ($category->parent_id == $cat->id) selected @endif style="font-size:20px">
                                                                {{ $cat->name }}
                                                            </option>
                                                ...
                                                @if ($photo)
                                                    <div>
                                                        <img src="{{asset('storage/'.$photo)}}" alt="category image"
                                                            style="width: 40%">
                                                    </div>
                                                @endif
